package com.epgis.navisdk.demo.utils;
...
import com.epgis.commons.geojson.GeoJson;
...
public class MapUtil {
    ...
    public static void openGaoDeNavi(Context context, double slat, double slon, String sname, double dlat, double dlon, String dname) {
        ...
        Log.d(TAG, "openGaoDeNavi() uriString=" + uriString);

        //baidumap://map/direction?mode=driving&&destination=latlng:39.91058663444325,116.40388132245812|name:北京天安门
...
//        uriString=qqmap://map/routeplan?type=drive&policy=0&referer=zhongshuo&to=北京天安门&tocoord=39.9037448095,116.3980007172

        Log.d(TAG, "openTencentMap() uriString=" + uriString);
    ...
    public static void openBaiDuNavi(Context context, double slat, double slon, String sname, double dlat, double dlon, String dname) {
        ...
        uriString = "baidumap://map/direction?mode=driving&destination=latlng:39.9037,116.398|name:重点";

        Log.d(TAG, "openBaiDuNavi() uriString=" + uriString);
