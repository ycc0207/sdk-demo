...
public class MapItemSectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MapItemSectionAdapter(Context ctx, int sectionResourceId, int textResourceId,
    ...
    public static class SectionViewHolder extends RecyclerView.ViewHolder {
        ...
        public SectionViewHolder(@NonNull View view, @IdRes int textRes) {
            ...
            title.setTypeface(FontCache.get("fonts/fangzhengcuyuan.ttf", view.getContext()));
        }
    }
